...
export const authProvider: AuthProvider = {
  login: async ({ email }) => {
    try {
      ...
      // dataProvider.custom is used to make a custom rqeuest to the GraphQL API
      ...
      const { data } = await dataProvider.custom({
        ...
        headers: {},
        meta: {
          // pass the email to see if the user exists and if sp, return the accessToken
          variables: { email },
          rawQuery: `
  ...
  getIdentity: async () => {
    ...
    // we're using me: any becuase the GraphQL API doesn't have a type for the me query yet.
